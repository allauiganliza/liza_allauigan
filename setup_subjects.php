...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $stmt = $conn->prepare("INSERT INTO subjects (subject_code, subject_description, units, prerequisite) VALUES (?, ?, ?, ?)");
    $stmt->bind_param("ssss", $subject_code, $subject_description, $units, $prerequisite);

    if ($stmt->execute()) {
        $message = "Course added successfully!";
        // Redirect to prevent duplicate submissions
        header('Location: setup_subjects.php');
        exit();
    } else {
...
<body>
    ...
    <form method="post" action="">
        ...
        <br>
        <input type="submit" value="Add Course" onclick="showAlert('Subjects added successfully!')">
    </form>
    ...
    <table border="1">
        ...
        <tbody>
            ...
            $sql = "SELECT subject_code, subject_description, units, prerequisite FROM subjects";
